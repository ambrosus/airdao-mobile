  ...
  async getBalanceBlockchain(address) {
    ...
    BlocksoftCryptoLog.log(
      this._settings.currencyCode +
        ' WavesScannerProcessorErc20 getBalanceBlockchain address ' +
        address
    );

    const link =
      this._apiPath + '/assets/balance/' + address + '/' + this._tokenAddress;
    ...
    try {
      ...
      BlocksoftCryptoLog.log(
        this._settings.currencyCode +
          ' WavesProcessorErc20 getBalanceBlockchain address ' +
          address +
          ' balance ' +
          JSON.stringify(res) +
          ' to hex error ' +
