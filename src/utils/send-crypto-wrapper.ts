...
const CACHE_DATA = {
  countedFeesData: {} as AirDAOBlockchainTypes.TransferData,
...
export namespace SendActionsBlockchainWrapper {
  export const beforeRender = (
    ...
    const {
      hash: walletHash,
      useUnconfirmed: walletUseUnconfirmed,
      allowReplaceByFee: walletAllowReplaceByFee,
    ...
    const newCountedFeesData = {
      ...
      useLegacy: walletUseLegacy,
      isHd: Boolean(walletIsHd),
      accountJson,
      transactionJson: {}
    } as AirDAOBlockchainTypes.TransferData;
  ...
  export const getFeeRate = async (
    ...
    try {
      ...
      if (typeof e.message === 'undefined') {
        ...
        // TODO
        // const extend = AirDAODict.getCurrencyAllSettings(
