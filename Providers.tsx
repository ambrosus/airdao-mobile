...
import { DEXSwapContextProvider } from '@features/dex-swap-interface/model/dex-swap.context';
...
const DEXSwapInterfaceProvider = ({ children }: any) => (
  // @ts-ignore
  <DEXSwapContextProvider>{children}</DEXSwapContextProvider>
);
